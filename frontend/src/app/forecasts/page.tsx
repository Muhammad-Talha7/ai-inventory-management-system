              ...
              <div className="max-h-64 overflow-y-auto p-1">
                {filteredProducts.map(p => (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 text-left text-sm rounded-xl transition-colors ${selectedProductId === p.product_id ? 'bg-indigo-50 text-indigo-700' : 'text-slate-600 hover:bg-slate-50'
                      }`}
                  >
